...
for j in range(len(ep)):
    #%% Set file directory
    data_file = '../'
    outdir = data_file + 'result_for_brain/' + method + '/epoch' + str(epoch_file[j])
    print("outdir is {}".format(outdir))
    #outname = 'deepimmuno-GANRL-bladder-epoch' + str(num_epochs) + '.txt'
    outname = 'deepimmuno-GANRL-brain-epoch' + str(num_epochs[j]) + '-batch' + str(batch_size[j]) + '.txt'
    ...
    G.load_state_dict(torch.load(data_file + 'result_for_brain/' + method + '/epoch' + str(epoch_file[j]) + '/model_epoch_' + str(num_epochs[j]) + '.pth'))
...
#%% Set file directory
data_file = '../'
outdir = data_file + 'result_for_brain/' + method + '/epoch' + str(epoch_file)
print("outdir is {}".format(outdir))
#outname = 'deepimmuno-GANRL-bladder-epoch' + str(num_epochs) + '.txt'
outname = 'deepimmuno-GANRL-brain-epoch' + str(num_epochs) + '-batch' + str(batch_size) + '.txt'
...
# #G.load_state_dict(torch.load('./models/wassGAN_G.pth'))
G.load_state_dict(torch.load(data_file + 'result_for_brain/' + method + '/epoch' + str(epoch_file) + '/model_epoch_' + str(num_epochs) + '.pth'))
