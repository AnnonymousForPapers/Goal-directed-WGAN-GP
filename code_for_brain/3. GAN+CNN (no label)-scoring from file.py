...
for j in range(len(ep)):
    ...
    outname = 'deepimmuno-GANRL-brain_cancer-scored_epoch' + str(num_epochs[j]) + '-batch' + str(batch_size[j]) + '.txt'
    """
    Test peptides data
    """
    #data_path = 'D:/PhD thesis/GCN/My Code/' + method + '/' + ep[i] + '/deepimmuno-GANRL-bladder-' + ep[i] + '_rmv.txt'
    data_path = data_file + 'result_for_brain/' + method + '/' + ep[j] + '/deepimmuno-GANRL-brain-epoch' + str(num_epochs[j]) + '-batch' + str(batch_size[j]) + '_rmv.txt'
