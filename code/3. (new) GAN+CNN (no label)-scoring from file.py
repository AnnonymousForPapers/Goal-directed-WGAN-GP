...
'''
"""
Created on Sun Jan 14 22:58:36 2024
...
for j in range(len(ep)):
    ...
    data_path = data_file + 'Data/' + method + '/' + ep[j] + '/deepimmuno-GANRL-bladder-epoch' + str(num_epochs[j]) + '-batch' + str(batch_size[j]) + '_rmv.txt'
