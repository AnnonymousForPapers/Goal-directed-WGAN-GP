...
method = 'Goal-directed_WGAN-GP_1'
input_dir1 = data_file + 'Data/' + method + '/' + 'epoch' + str(num_epochs_1000)
...
input_dir2 = data_file + 'Data/' + method + '/' + 'epoch' + str(num_epochs_1000)
...
plt.legend(['WGAN-GP','Goal-directed WGAN-GP (no gamma and scale)'],fontsize = 15)
