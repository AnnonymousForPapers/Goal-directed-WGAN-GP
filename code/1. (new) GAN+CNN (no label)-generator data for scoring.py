...
'''
"""
Created on Wed Jan 10 19:54:43 2024
...
for j in range(len(ep)):
    ...
    outdir = data_file + 'data/' + method + '/epoch' + str(epoch_file[j])
    ...
    G.load_state_dict(torch.load(data_file + 'data/' + method + '/epoch' + str(epoch_file[j]) + '/model_epoch_' + str(num_epochs[j]) + '.pth'))
...
#%% Set file directory
data_file = 'D:/PhD thesis/GAN/Github/'
outdir = data_file + 'data/' + method + '/epoch' + str(epoch_file)
print("outdir is {}".format(outdir))
#outname = 'deepimmuno-GANRL-bladder-epoch' + str(num_epochs) + '.txt'
